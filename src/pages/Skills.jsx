  ...
  return (
    <>
      ...
      <section className="py-16 px-4 text-center">
        ...
        >
          I specialize in front-end web development, building responsive, visually engaging,
           and user-centered websites. Using HTML5, CSS3, Tailwind CSS, JavaScript, and React, 
           I craft interfaces that balance clean design with functionality. With Vite for lightning-fast 
           builds and Git for version control, I develop everything from static pages to dynamic single-page applications — all 
           optimized for performance, accessibility, and an exceptional user experience.
        </motion.p>
      ...
      <section className="py-16 px-4 bg-neutral-800">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            transition={{ delay: 0.2, duration: 0.6 }}
            viewport={{ once: true }}
            className="mb-10 text-white leading-relaxed max-w-2xl mx-auto text-base md:text-lg"
            style={{ fontFamily: "satoshi-medium" }}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-neutral-900 rounded-lg p-6 hover:shadow-lg transition-shadow flex flex-col items-center text-center"
              >
                {service.icon}
                <h5
                  className="mb-3 text-lg md:text-xl text-white"
