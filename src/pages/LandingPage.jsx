...
const LandingPage = () => {
  return (
    <>
      {/* HERO SECTION */}
      <section className="min-h-screen flex flex-col md:flex-row items-center justify-between -mt-10 bg-gray-900 px-10 md:px-16 py-12 gap-10 md:gap-0">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl text-gray-400 mb-4" style={{fontFamily: 'satoshi-black'}}>
            Hi, I’m Joshua Dave Gallares
          </h1>

          <p className="text-xl sm:text-2xl md:text-3xl text-gray-400 mb-6" style={{fontFamily: 'satoshi-medium'}}>
            Aspiring
          ...
          <p 
            className="mt-4 text-lg text-white italic" 
